...
SAVE_LOC = "E:\\Landsat\\Collection 1\\Level 1\\2021"
...
band_1 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_1")]))
band_2 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_2")]))
band_3 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_3")]))
band_4 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_4")]))
band_5 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_5")]))
band_6 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_6")]))
band_7 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_7")]))
band_8 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_8")]))
band_9 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_9")]))
band_10 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_10")]))
band_11 <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_11")]))
band_qa <- raster(file.path(folder_dir, mtl$Value[which(mtl$Variable=="FILE_NAME_BAND_QUALITY")]))
